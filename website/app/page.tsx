    ...
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          <p className="eyebrow"><span /> Open-source agent infrastructure · v0.4.3 · portable handoffs</p>
      ...
      <section className="honest-section">
        <div className="honest-copy">
          ...
          <p>Version 0.4.3 compiles, runs, resumes, inspects, and rejects unsafe local workflows. It includes contract-bound memory, evidence, cost enforcement, approval gates, specialist routing, portable takeover checkpoints, an in-process MCP compatibility proof, a repository-native shared-agent bridge, a local concurrency rehearsal, a proof-release gate, a token-capacity gate, an additive token-efficiency layer, a digest-bound adoption scorecard with a repeatable evaluation matrix and comparative rollback rule, a signed provider-compatibility receipt that keeps synthetic rehearsals separate from real-provider evidence, and an optional DeepSeek function-calling bridge for bounded read-only work.</p>
